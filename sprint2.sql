...
select
    ...
    si.vendorid,
    transfer_type,
    date_part('day', age(tt3.shipping_end_fact_datetime, tt3.shipping_start_fact_datetime)) as full_day_at_shipping,
    case
        when tt3.shipping_end_fact_datetime > s.shipping_plan_datetime then 1
        else 0
    end as is_delay,
    case
    ...
    case
        when tt3.shipping_end_fact_datetime >s.shipping_plan_datetime then date_part('day', age(tt3.shipping_end_fact_datetime, s.shipping_plan_datetime))
        else 0
